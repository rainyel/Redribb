...
export default class CJSImportTransformer extends Transformer {
  ...
  processExport() {
    ...
    if (this.tokens.matches2(tt._export, tt._default)) {
      ...
      this.tokens.removeInitialToken();
  þÿÿÿ    V     üS T     ?T ST     ‚T –T     ÈT ÜT     ÷T U     5U IU     {U U     ÌU àU     þÿÿÿ    Ìÿÿÿ    þÿÿÿ    kX     þÿÿÿ    Øÿÿÿ    þÿÿÿ‹Y žY      `                 Ër“\    ü\           è\  ð\  ø\  °N  àN  ]  ]     FDDevQuery.DLL DllCanUnloadNow DllGetClassObject                                                                                                                                                                                                                    à 0 p. @.         € €                     °\ ´\                                 ÿÿÿÿNæ@»±¿D    ,                                                                                                                                                                                                                                                                                                                                                                                                               Fx  ‚x  dx      ®x      &x      vt  (u  u  ft  Vt  ´t   t      ru  <u  ìt  Vu      u      èu  Òu  u  ¤u      ¸u      ˆt  Æt  :t  "t  
t  Üt  üt      Nu      v  þu      ~w  Jw  `w  Äw  –w      ¨w      ®s   s  ’s  Ps  Æx  ès  òs   t  ºs  †s  |s  ps  hs  \s  às  Ðx      ðZ s          Ôs  Ìp  ¸r          (v  xp  `r          Jv   p  €r          jv  @p  ”r          ”v  Tp  Ør          ¶v  ˜p  œr          Øv  \p  °r          w  pp  àr          &w   p  ìr          Þw  ¬p  s          x  Äp  Xr          :x  p  @r          ¢x   p  Pr          ºx  p                      Fx  ‚x  dx      ®x      &x      vt  (u  u  ft  Vt  ´t   t      ru  <u  ìt  Vu      u      èu  Òu  u  ¤u      ¸u      ˆt  Æt  :t  "t  
t  Üt  üt      Nu      v  þu      ~w  Jw  `w  Äw  –w      ¨w      ®s   s  ’s  Ps  Æx  ès  òs   t  ºs  †s  |s  ps  hs  \s  às  Ðx      _wcsicmp  _purecall Åfree  
memcpy_s  ýmalloc  "_callnewh o _XcptFilter _amsg_exit  è_initterm j_except_handler4_common msvcrt.dll  `_lock Ä_unlock  __dllonexit 	_onexit  EnterCriticalSection   LeaveCriticalSection   InitializeCriticalSection C CoTaskMemFree N IIDFromString  CLSIDFromString  DeleteCriticalSection P PropVariantClear  B CoTaskMemAlloc  6 WaitForSingleObject  CreateEventW   GetLastError  ) SetEvent    CloseHandle T StringFromGUID2 	 CoCreateInstance   RaiseException  - Sleep  UnhandledExceptionFilter   SetUnhandledExceptionFilter  GetCurrentProcess N TerminateProcess    QueryPerformanceCounter  GetCurrentProcessId  GetCurrentThreadId   GetSystemTimeAsFileTime  GetTickCount  api-ms-win-core-synch-l1-1-0.dll  api-ms-win-core-com-l1-1-0.dll  api-ms-win-core-errorhandling-l1-1-0.dll  api-ms-win-core-handle-l1-1-0.dll api-ms-win-core-synch-l1-2-0.dll  api-ms-win-core-processthreads-l1-1-0.dll api-ms-win-core-profile-l1-1-0.dll  api-ms-win-core-sysinfo-l1-1-0.dll    DevCloseObjectQuery  DevCreateObjectQueryFromId   DevCreateObjectQuery   DevFindProperty  DevGetObjectPropertiesEx   DevFreeObjectProperties api-ms-win-devices-query-l1-1-0.dll api-ms-win-devices-query-l1-1-1.dll ®UnregisterClassA  USER32.dll  / PSCreatePropertyChangeArray - PSCreateMemoryPropertyStore 2 PSCreateSimplePropertyChange  PROPSYS.dll ,StrCmpNW  SHLWAPI.dll memcmp  memset                                                                                                                                                                                                                                                                                                                            €                  0  €               	  H   `€  Ð                  À4   V S _ V E R S I O N _ I N F O     ½ïþ     
  aJ  
  aJ?                           S t r i n g F i l e I n f o   ú   0 4 0 9 0 4 B 0   L   C o m p a n y N a m e     M i c r o s o f t   C o r p o r a t i o n   t &  F i l e D e s c r i p t i o n     M i c r o s o f t   W i n d o w s   D e v i c e   Q u e r y   H e l p e r   h $  F i l e V e r s i o n     1 0 . 0 . 1 9 0 4 1 . 1   ( W i n B u i  2 < this.tokens.tokens.length &&
